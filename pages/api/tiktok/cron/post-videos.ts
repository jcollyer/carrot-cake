...
export default async function GET(req: Request) {
  ...
  console.log(`Cron job executed successfully with ${videosPosted} videos posted`);
  return Response.json({ message: `Cron job executed successfully with ${videosPosted} videos posted` });
}
